  ...
  return (
    <div className='container mx-auto py-10'>
        ...
        <form onSubmit={handleSubmit}>
            ...
            <textarea rows={20} cols={100} onChange={(e) => setContent(e.target.value)} className='w-fullblock bg-gray-200 border py-2 px-3 rounded text-lg my-2' placeholder='Enter your content'></textarea>
